...
- Copy the following content [Dockerfile](/Documentation/Scripts/Docker/Dockerfile) (**Gcloud Instance**)
...
- Copy the following content [Deploy.ps1](/Documentation/Scripts/Ps1/Deploy.ps1) (**Local Host**)
